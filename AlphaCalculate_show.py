...
if __name__ == '__main__':
    ...
    img_path = 'C:/Users/wang/Desktop/final_tons/1-26-2.jpg'
    ...
    # the color of tonge
    color_base = FindColor.findBaseColor(img_path)
    print(color_base)
    ...
    p1=plt.subplot(221), plt.imshow(img_origin)
    plt.title('original image')
    p2=plt.subplot(222), plt.imshow(tonge_coating)
    plt.title('tonge coating image')
    p3=plt.subplot(223), plt.imshow(img_thickness,cmap='gray')
    plt.title('tonge coating thickness')
    p4=plt.subplot(224),plt.imshow(tonge_coating_mix)
