...
def train(aug, trainX, trainY, testX, testY, args):
    ...
    plt.title("Training Loss and Accuracy on tonge classifier")
    plt.xlabel("Epoch #")
...
# python train.py --dataset_train ../../train --dataset_test ../../test --model tonge.model
